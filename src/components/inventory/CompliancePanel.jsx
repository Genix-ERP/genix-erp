              ...
              <div>
                ...
                {compliance.issues.map((issue, idx) => (
                  <div key={idx} className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg text-sm mb-2">
                    ...
                    <p className="text-yellow-700 mt-1">Solution: {issue.solution}</p>
                  </div>
                ))}
              </div>
            )}
      ...
      <Dialog open={showSettings} onOpenChange={setShowSettings}>
        <DialogContent className="sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription>
              Review and configure compliance settings
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="p-4 bg-slate-50 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span className="text-slate-600">Accounting Standard:</span>
                  <span className="font-medium">{compliance.standard_detected}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-600">Default Costing Method:</span>
                ...
                <div className="flex justify-between">
                  <span className="text-slate-600">Auto-Compliance Check:</span>
                  <span className="font-medium text-green-600">Enabled</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-4 bg-blue-50 rounded-lg">
              <p className="text-sm text-blue-800">
                <strong>Note:</strong> Compliance settings will be fully configurable when connected to the backend.
                Currently using default IFRS-compliant settings.
              </p>
            </div>
          </div>
          <div className="flex gap-3">
