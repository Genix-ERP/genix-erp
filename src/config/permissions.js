...
export const PERMISSION_MATRIX = {
  ...
  [PERMISSION_LEVELS.BASIC]: {
    ...
    [MODULES.TASKS]: [OPERATIONS.READ, OPERATIONS.CREATE],
    [MODULES.REPORTS]: [OPERATIONS.READ],
  ...
  [PERMISSION_LEVELS.IMPORTANT]: {
    ...
    [MODULES.TASKS]: [OPERATIONS.READ, OPERATIONS.CREATE, OPERATIONS.UPDATE],
  ...
  [PERMISSION_LEVELS.GRANT]: {
    ...
    [MODULES.TASKS]: [OPERATIONS.READ, OPERATIONS.CREATE, OPERATIONS.UPDATE, OPERATIONS.DELETE],
